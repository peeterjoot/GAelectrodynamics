...
What
differentiates GA from vector algebra is a \boldTextAndIndex{multiplication operation}.
This
...
A sum of k-vectors (with different \(k\)) is called a \boldTextAndIndex{multivector}.  Such a sum is 
...
\boldTextAndIndex{multivector space}.
