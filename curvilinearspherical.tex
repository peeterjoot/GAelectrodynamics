...
The spherical vector parameterization admits a compact GA representation.  We illustrate our conventions in \cref{fig:sphericalPolar:sphericalPolarFig1}.
...
\end{equation}
\end{subequations}
See \cref{problem:dexpquestion:1} for additional notes about this last computation.
These vectors are all mutually orthogonal, which can be verified by computing dot products.
%\iftoggle{kindle-version}{}{
