...
%%%
%%%\begin{equation}\label{eqn:curvilinearDefinedCoordinates:380}
%%%\Bf = \sum_i a_i \Bx_{u_i}.
%%%\end{equation}
%%%
%%%Dotting with \( \Bx^{u_j} \) gives
%%%
%%%\begin{equation}\label{eqn:curvilinearDefinedCoordinates:280}
%%%\Bf \cdot \Bx^{u_j}
...
%%%
%%%so
%%%\begin{equation}\label{eqn:curvilinearDefinedCoordinates:300}
