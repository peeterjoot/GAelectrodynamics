...
Some, but not all, of the places requiring generalizations for mixed signature (relativitistic) spaces will be pointed out.
%geometric algebras generated an orthonormal basis \( \setlr{\Be_1, \Be_2, \cdots } \) is assumed for the remainder of this chapter.}
