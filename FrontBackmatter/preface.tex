...
This is a single multivector equation that is easier to solve and manipulate than the conventional mess of divergence and curl equations are familiar to the reader.
