...
\pmathImageFigure{../figures/GAelectrodynamics/\subfigdir/}{linearPolarizationFig1}{Linear polarization.}{fig:linearPolarization:linearPolarizationFig1}{0.3}{linearPolarizationFig1.nb}
...
\end{aligned}
\end{equation}
This allows for unconditionally factoring of \( \Be_1 \) from \cref{eqn:polarizationRewrite:980}, so the field is
