...
%%\begin{equation}\label{eqn:frequencydomainPlaneWaves:200}
%\boxedEquation
...
the field is
\begin{equation}\label{eqn:polarization:20}
\begin{aligned}
...
\begin{equation}\label{eqn:polarization:640}
\BE =
...
\begin{equation}\label{eqn:polarization_circular:160}
\begin{aligned}
F&(\Bx, t)  \\
&= (1 + \Be_3) \lr{
...
\begin{equation}\label{eqn:polarization_linearPolarization:280}
\begin{aligned}
...
\end{equation}
so the field is
\begin{equation}\label{eqn:polarization_linearPolarization:300}
...
\pmathImageFigure{../figures/GAelectrodynamics/}{linearPolarizationFig1}{Linear polarization.}{fig:linearPolarization:linearPolarizationFig1}{0.3}{linearPolarizationFig1.nb}
...
\begin{equation}\label{eqn:polarization_circular:180}
\begin{aligned}
...
\begin{equation}\label{eqn:polarization_elliptical:340}
\BE
=
...
\begin{equation}\label{eqn:polarization_elliptical:400}
\begin{aligned}
...
\begin{equation}\label{eqn:polarization_elliptical:420}
...
in the compact form
\begin{equation}\label{eqn:polarization_elliptical:360}
\Br(\phi)
=
...
\begin{equation}\label{eqn:polarization_elliptical:380}
\begin{aligned}
...
\pmathImageFigure{../figures/GAelectrodynamics/}{ellipticalPolarizationFig1}{Electric field with elliptical polarization.}{fig:ellipticalPolarization:ellipticalPolarizationFig1}{0.3}{ellipticalPolarizationFig1.nb}
...
\begin{equation}\label{eqn:polarizationRewrite:760}
...
\begin{equation}\label{eqn:polarizationRewrite:780}
\begin{aligned}
F F^\dagger
&=
...
\begin{equation}\label{eqn:polarizationRewrite:800}
\begin{aligned}
F \Be_3 F^\dagger
...
so \( T(\Be_3) = -T(1) \).
For \( T(\Be_1) \), we have
\begin{equation}\label{eqn:polarizationRewrite:820}
\begin{aligned}
F \Be_1 F^\dagger
...
\end{aligned}
\end{equation}
Clearly \( F \Be_2 F^\dagger = 0 \) as well, so \( T(\Be_1) = T(\Be_2) = 0 \).
...
\begin{equation}\label{eqn:polarizationRewrite:840}
...
\begin{equation}\label{eqn:polarizationRewrite:860}
...
\begin{equation}\label{eqn:polarizationRewrite:1040}
f(\phi) = e E_a \cosh\lr{ m + i \phi}.
\end{equation}
The absolute value of \( f \) is
\begin{equation}\label{eqn:polarizationRewrite:880}
\begin{aligned}
f f^\dagger
...
\begin{equation}\label{eqn:polarizationRewrite:940}
\begin{aligned}
F
...
\begin{equation}\label{eqn:polarizationRewrite:960}
F
...
\begin{equation}\label{eqn:polarizationRewrite:980}
\begin{aligned}
...
\begin{equation}\label{eqn:polarizationRewrite:1000}
\begin{aligned}
\lr{ 1 + \Be_3 } I \Be_2
&= \lr{ 1 + \Be_3 } \Be_{31} \\
&= \lr{ 1 + \Be_3 } \Be_{1}.
\end{aligned}
\end{equation}
This allows us to unconditionally factor out \( \Be_1 \) from \cref{eqn:polarizationRewrite:980}, so the field is
\begin{equation}\label{eqn:polarizationRewrite:1020}
\begin{aligned}
F
