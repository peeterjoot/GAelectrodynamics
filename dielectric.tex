...
\subsection{Transforming away the grade selection operations.}
...
for the spacetime gradient.  However, we may make a gauge-like transformation of the fields, and use
such transformations to solve simpler equations free of the grade selection operations.
