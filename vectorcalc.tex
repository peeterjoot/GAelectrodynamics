...
\end{aligned}
\end{equation}
The \R{3} part of the lemma can be shown using \cref{lemma:vectorcalc:660}, or we can compute it directly
...
\end{aligned}
\end{equation}
The \R{3} case, is less obvious by inspection, but follows from \cref{lemma:vectorcalc:660}.
\end{proof}
%}
