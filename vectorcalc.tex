...
This definition differs from the conventional definition of \R{3} curl, expressed as a cross product, but is a much more useful and fundamental definition to use in the context of geometric algebra, and is worth the bit of ambiguity it introduces.
