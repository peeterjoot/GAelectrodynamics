...
\renewcommand{\basename}{multivectorPotential}
...
\generatetitle{Multivector potential}
%\chapter{Multivector potential}
\label{chap:multivectorPotential}
...
We want find the geometric algebra generalization of the static and vector potentials.  We will start with the potentials for static configurations where all the time derivatives

\subsection{Statics potentials.}

\subsection{REWRITE MARKER.}
