...
Show that the relations \cref{eqn:quaternion2maxwellWithGA:240} are satisfied by the unit bivectors \( \Bi = \Be_{32}, \Bj = \Be_{13}, \Bk = \Be_{21} \), demonstrating that quaternions, like complex numbers, may be represented as multivector subspaces.
} % problem
%}
