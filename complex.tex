...
%{
\index{\(i\)}
\maketheorem{Unit bivector imaginary nature.}{thm:2dMultiplication:320}{
Let \( i = \Bu \Bv \), where \( \Bu, \Bv \) are any pair of orthonormal vectors.  The ``unit'' bivector \( i \) has the characteristics of an imaginary number, that is
\begin{equation*}
i^2 = -1.
\end{equation*}
} % theorem
...
\maketheorem{Unit trivector imaginary nature.}{thm:complex:trivectorImaginary}{
Let \( I = \Bu \Bv \Bw \), where \( \Bu, \Bv, \Bw \) are any three orthonormal vectors.  The ``unit'' trivector \( I \) has the characteristics of an imaginary number, that is
\begin{equation*}
I^2 = -1.
\end{equation*}
} % theorem
...
%\maketheorem{Complex representation of plane vectors.}{thm:complex:3450}{
%} % theorem
