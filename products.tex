...
Let \( \Ba \) and \( \Bb \) be two vectors on the plane formed by orthonormal vectors \( \Bu \) and \( \Bv \), where \( \Bu, \Bv \) are
oriented in a positive rotational sense as illustrated in
