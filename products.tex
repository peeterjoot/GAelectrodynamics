...
We recognize the scalar grade of the vector product as the \R{N} dot product, but the grade 2 component of the vector product is something new that requires a name.  We respectively identify and define operators for these vector grade selection operations
...
The cross product is also bilinear, so one can reasonably expect this of the wedge product.  This is much easier to demonstrate using a coordinate expansion.  To do so let
...
%
%proves that
%\cref{eqn:products:1780} holds for any vectors, and not just when they are normal.  Because of this antisymmetry we also have
%
