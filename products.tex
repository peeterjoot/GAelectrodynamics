...
\end{aligned}
\end{equation}
\pmathImageFigure{../figures/GAelectrodynamics/\subfigdir/}{exponentialVectorProductFig1}{Equilateral triangle in \R{3}.}{fig:exponentialVectorProduct:exponentialVectorProductFig1}{0.3}{compositionOfExponentials.nb}
