...
Any orthonormal basis is also its reciprocal basis.
...
As the book is concerned primarily with Euclidean spaces, the absolute values of such area and volume differentials are \( dA = \sqrt{} -( d^2 \Bx)^2, dV = \sqrt{} -( d^3 \Bx)^2 \), which are the respective areas and volumes of the paralellogram and paralellopiped spanned by the vector differentials in each of the parameterization directions.
