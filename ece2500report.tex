...
These authors argue that a paravector representation provides an effective pedagodical bridge from Euclidean geometry to the Minkowski geometry of special relativity.
...
The end product of this project was a small self contained book including an introduction to Euclidean geometric algebra, geometric calculus, and applications to electromagnetism.
This report summarizes results from this book, omitting most derivations, and attempts to provide an overview of the work that can be used as a road map to the book for further exploration.
