...
FIXME: look up (or derive the quaterion representation.)
...
Most grievous of the costs is the requirement to use differentials \( dx^1, dx^2, dx^3, c dt \), instead of a more familar set of direction vectors, even when using a non-curvilinear basis.  This requirement is easily viewed as unnatural, and likely a primary reason that electromagnetism with differential forms has never become popular.
...
An exploration of geometric algebra applications to electromagnetism was also written,
where
many of the fundamental results of electromagnetism were
derived directly from the geometric algebra form of Maxwell's equation
in a streamlined and compact fashion.
Like STA we use a use the hybrid electromagnetic field representation of \cref{eqn:ece2500report:200},
however, here
\( I = \Be_1 \Be_2 \Be_3 \) is the \R{3} pseudoscalar, the ordered product of the basis vectors \( \setlr{ \Be_i } \), and \( F \) is considered a multivector with vector and bivector
...
they are plain old Euclidian vectors in \R{3}, entirely consistent with conventional Heaviyside-Gibbs
notation.
...
The paravector form of Maxwell's equation is exactly that of
\cref{eqn:ece2500report:120}, however, most of the paravector literature is focused on
relativistic applications, and it is not terribly accessible to engineers or engineering students.
