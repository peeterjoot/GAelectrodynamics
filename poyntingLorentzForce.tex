...
Can we put the RHS sum into the form \( \spacegrad \cdot X \) for some multivector \( X \), and provide a geometric interpretation to the \( T_{jk}, j,k \in [1,3] \) subset of the stress tensor?

%FIXME: following wrong.
%More generally we make the identification
%
