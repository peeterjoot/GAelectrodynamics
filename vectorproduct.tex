...
This is possible since the dual of the normal, \( I \ncap \), is a bivector representing the plane of rotation, and acts as an imaginary
...
Observe the similarity between this and the complex inner product \( z w^\conj = r \rho e^{i(\theta-\alpha)} \) for the two complex numbers of \cref{eqn:GAmotivation:200}.
