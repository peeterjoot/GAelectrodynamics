...
%\begin{equation}\label{eqn:potentialSection_farfield:2560}
\begin{equation*}
\begin{aligned}
...
\pmathImageFigure{../figures/GAelectrodynamics/}{vectorPotentialFig1}{Vertical infinitesimal dipole and selected propagation direction.}{fig:vectorPotential:vectorPotentialFig1}{0.3}{zcapPotential.nb}

The wedge of \( \kcap \) with \( \BA \) is proportional to
\begin{equation}\label{eqn:potentialSection_farfield:2660}
\begin{aligned}
\kcap \wedge \Be_3
