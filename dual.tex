...
%
\Cref{eqn:2dRotations:300} and \cref{eqn:2dRotations:3} showed that multiplying a vector in a plane by a unit pseudoscalar for that plane, maps a vector (say \( \Bx \)) to a vectort \( i \Bx \) that is orthogonal to \( \Bx \).  For the x-y plane with \( i = \Be_{12} \), these can be summarized in polar form as
