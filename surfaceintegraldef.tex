...
\pmathImageFigure{../figures/GAelectrodynamics/}{\subfigdir/twoParameterDifferentialFig1}{Two parameter manifold differentials.}{fig:twoParameterDifferential:twoParameterDifferentialFig1}{0.4}{twoParameterDifferentialFig.nb}
...
\begin{equation}\label{eqn:surfaceintegraldef:200}
\begin{aligned}
\int F d^2\Bx
&=
...
\end{equation}
so
\begin{equation}\label{eqn:surfaceintegraldef:240}
\begin{aligned}
\int F d^2\Bx
&= \alpha I 4 \pi r^2 + \beta r \int \phicap \sin\theta d\theta d\phi - \gamma r \int \thetacap d\theta d\phi \\
&= \alpha I 4 \pi r^2,
\end{aligned}
\end{equation}
