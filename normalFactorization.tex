...
degrees(\( \lr{ B \cdot \Be} \Be \) would be the projection itself.)  If we dot \( \Ba \) with \( B \) then we find another vector that lies in the plane represented by \( B \), but is rotated
