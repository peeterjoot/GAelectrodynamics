...
A (real) vector space is a set \( V \), the elements of which are called vectors, has an addition operation designated \( + \) and a scalar multiplication operation designated by juxtaposition, where the following axioms are satisfied
