...
FIXME: like magnetostatics.tex, include the Green's convolution integral here explicitly for clarity.
...
FIXME: rework this so that it does not depend on the Green's solution, and comes first (as it is simpler).
