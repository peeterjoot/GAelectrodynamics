...
Later, we will see that this latter half angle rotation operator will be the desired form of a general rotation in \R{N}.  This generalized rotational structure that follows that such a complex exponential commutes with any vectors that lie outside of the plane.
