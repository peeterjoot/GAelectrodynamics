...
In a 2D space many of the interesting vector products involve the unit bivector \( i = \Be_1 \Be_2 \).
...
Observe that the pseudoscalar \( i \) does not commute with either basis vector.  It is left as a problem to show that \( i \) anticommutes with any vector in the plane.
The products tabulated in \cref{eqn:SimpleProducts2:180} are illustrated in \cref{fig:rotationOfe1:rotationOfe1Fig1}.
