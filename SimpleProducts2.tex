...
Here's a tabulation of some properties of the cross product against those of the wedge product.
%\label{tab:SimpleProducts2:10}
...
Note that the determinant expansion of the wedge product in the table above is only valid for \R{3}, but all the other wedge product properies are general.
