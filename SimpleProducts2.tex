...
{../figures/GAelectrodynamics/rotationOfVFig1}
{Multiplication by \( \Be_1 \Be_2 \).}{fig:rotationOfe1:rotationOfe1Fig1}{scale=0.3}
...
%\cref{fig:rotationOfV:rotationOfVFig1}.
%\imageFigure{../figures/GAelectrodynamics/rotationOfVFig1}{CAPTION: rotationOfVFig1}{fig:rotationOfV:rotationOfVFig1}{0.3}
