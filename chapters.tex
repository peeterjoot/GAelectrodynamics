...
%<WRITING HERE IS TOO OBSCURE, NOT FOR THE TARGET AUDIENCE>
%
% WRITE NEW INTRODUCTION LATER AFTER THE CONTENT.
%
...
Generalizations required for non-Euclidean spaces will be discussed when spacetime vectors are introduced.
      ...
      %\section{Problem solutions}
      %   \shipoutAnswer
   \chapter{REWORK FROM HERE.}
         \input{SimpleProducts3.tex}
      \input{multivectorProblems.tex}
         \input{multivector2.tex}
         \input{SimpleProducts.tex}
         \subsection{Problems}
            %\input{left2dimaginarymultiplication.tex}
...
%         \paragraph{Rotation}
%FIXME: rework small rotation section for \R{N} and move it here.
      ...
      \section{Problem solutions}
         \shipoutAnswer
%   \chapter{Find a home for this example.}
%       \input{maxwellstatics.tex}
%         % contains 'We see' type language, inconsistent with the new writing.
