      ...
      \section{Analysis.}
         ...
         \subsection{Multivector dot product.}
            ...
            \subsubsection{Problems.}
               \makeproblem{Distribution of unit vector-bivector dot product.}{problem:generalizedDot:distributionUnitVectors}{
\makesubproblem{}{problem:generalizedDot:distributionUnitVectors:a}
Given indexes \( j \ne k \), prove that
\begin{equation*}
...
Prove \cref{{eqn:generalizedDot:980}.
               ...
               \input{bivectorDot.tex}
                  \shipoutAnswer
         \subsection{Scalar selection theorems.}
