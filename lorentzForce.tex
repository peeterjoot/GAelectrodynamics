...
We may define a \textit{multivector charge} that includes both the magnitude and velocity (relative to the speed of light) of the charge.  For electric charges this is
\begin{equation*}
Q_\txte = q_\txte \lr{ 1 + \Bv_\txte/c },
\end{equation*}
and for magnetic charges
\begin{equation*}
Q_\txtm = -I \epsilon q_\txtm \lr{ 1 + \Bv_\txtm/c }.
\end{equation*}
} % definition
