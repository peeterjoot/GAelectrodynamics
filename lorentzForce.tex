...
\( Q \) is an electric or magnetic charge/velocity multivector of \cref{dfn:lorentzForce:280}.
The conventional representation of the Lorentz force/power equations
\begin{equation*}
\begin{aligned}
\gpgradeone{ F Q } &= \ddt{\Bp} = q \lr{ \BE + \Bv \cross \BB } \\
c \gpgradezero{ F Q } &= \ddt{\calE} = q \BE \cdot \Bv.
\end{aligned}
\end{equation*}
...
\begin{equation*}
\begin{aligned}
\gpgradeone{ F Q } &= \frac{d\Bp}{dt} = \epsilon q_\txtm \lr{ c \BB - \inv{c} \Bv_\txtm \cross \BE } \\
c \gpgradezero{ F Q } &= \frac{d\calE}{dt} = \inv{\eta} q_\txtm \BB \cdot \Bv_\txtm.
\end{aligned}
\end{equation*}
} % theorem
