...
\begin{dmath}\label{eqn:greensFunctionFirstOrderHelmholtz:660}
\lr{ \spacegrad + j k } F(\Bx) = J(\Bx).
\end{dmath}

As above, this can be solved by assuming a superposition solution

\begin{dmath}\label{eqn:greensFunctionFirstOrderHelmholtz:680}
...
\cref{eqn:greensFunctionGradient:500}

\begin{dmath}\label{eqn:greensFunctionFirstOrderHelmholtz:840}
\begin{aligned}
...
Utilizing \cref{thm:gradientGreensFunctionEuclidean:720}, and substituting \( J(\Bx') \) from \cref{eqn:greensFunctionFirstOrderHelmholtz:660}, we find that one solution is
