   ...
   \mychapter{Electromagnetism.}
      ...
      \section{Statics.}
         ...
         \subsubsection{Infinite line current.}
            ...
            %\input{statics_infinitePlane_pillbox.tex}
            \input{statics_infiniteLineChargeMagneticLineCharge.tex}
         \subsubsection{Infinite planar current.}
            \input{statics_infinitePlane.tex}
            \input{statics_infinitePlaneMagneticProblem.tex}
