...
%{
   \chapter{Electromagnetism.}
      ...
      \section{Statics.}
         ...
         \subsection{Example: line segment.}
            \input{linecharge.tex}
         \subsection{Example.  Infinite line current.}
            \input{statics_infiniteLineCharge.tex}
         \subsection{Example.  Infinite planar current.}
            \input{statics_infinitePlane.tex}
         \subsection{Example: arc line charge.}
            \input{circularlinecharge.tex}
         \subsection{Example.  Field of a ring current.}
            \input{ringField.tex}
