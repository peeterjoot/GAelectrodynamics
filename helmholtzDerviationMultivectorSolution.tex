...
Both strategies will be illustrated here, as both use aspects of geometric calculus introduced in this chapter.
...
Switching to spherical coordinates \( \Br = \Bx' - \Bx = R\, \rcap(\theta, \phi) \) and noting that the outwards normal is given by
\( \ncap = (\Bx' - \Bx)/\Norm{\Bx' - \Bx} \), we have
