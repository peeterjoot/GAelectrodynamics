...
\begin{equation}\label{eqn:gagcProof:300}
\begin{aligned}
...
\begin{equation}\label{eqn:gagcProof:320}
\begin{aligned}
\int_V F d^k \Bx \lrboldpartial G
...
\begin{equation}\label{eqn:gagcProof:380}
\begin{aligned}
\sum_{i = 1}^2 \partial_i \lr{ I_3 \cdot \Bx^i }
&= \partial_1 ((\Bx_1 \wedge \Bx_2) \cdot \Bx^1) + \partial_2 ((\Bx_1 \wedge \Bx_2) \cdot \Bx^2) \\
&= \partial_1 (-\Bx_2) + \partial_2 \Bx_1 \\
&= -\frac{\partial^2 \Bx}{\partial u_1 \partial_2} +\frac{\partial^2 \Bx}{\partial u_2 \partial_1},
\end{aligned}
\end{equation}
...
\begin{equation}\label{eqn:gagcProof:400}
\begin{aligned}
...
\begin{equation}\label{eqn:gagcProof:420}
\begin{aligned}
I_k \cdot \Bx^i
...
\begin{equation}\label{eqn:gagcProof:340}
\begin{aligned}
\int_V F d^k \Bx \lrboldpartial G
