...
To show that this sums to zero in general observe that cyclic permuation of the wedge factors in the pseudoscalar only changes the sign
...
\Cref{eqn:fundamentalTheoremOfCalculus:320} is left with a sum of perfect differentials, each separately integratable
