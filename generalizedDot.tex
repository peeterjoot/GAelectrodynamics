...
\begin{equation}\label{eqn:generalizedDot:621}
...
\begin{equation}\label{eqn:generalizedDot:580}
...
\begin{equation}\label{eqn:generalizedDot:581}
...
\end{aligned}
\end{equation}
or a vector-trivector dot product
...
In an attempt to avoid inundating the reader with too many new operators, this book will stick to the dot, wedge and grade selection operators.  However, these alternates are common enough that they deserve mentioning.
%}
