...
\Cref{thm:generalizedDot:wedgeDotDistribution} can be used to expand \cref{eqn:generalizedDot:1220} further
...
completing the proof.  In \R{3} this identity also has a cross product equivalent
