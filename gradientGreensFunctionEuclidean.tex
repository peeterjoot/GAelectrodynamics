...
It can be shown that this Green's function is vector valued with the following structure
...
The structure of an unbounded superposition state can be determined by application of the fundamental theorem
