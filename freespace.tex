...
The sources \( \BM, \rho_\txtm \) can be considered fictional, representing physical phenomina such as infinitesimal current loops.
...
\begin{subequations}
\label{eqn:maxwellsEquations:900}
...
\Cref{eqn:maxwellsEquations:20} is the engineering convension (used herein), and \cref{eqn:maxwellsEquations:40} is the physics convension.  
