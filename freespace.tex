...
In free space these relationships are simply
...
It is possible to argue that \cref{eqn:freespace:220}, often omitted, is redundant (\cref{problem:freespace:LorentzPower}).
However,
