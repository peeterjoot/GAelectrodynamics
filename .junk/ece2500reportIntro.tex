...
\generatetitle{Intro for a report for the ECE2500 project producing the book: ``Geometric Algebra for Electrical Engineers''.}
\section{Motivation.}
This is the first draft of an introduction to a report I'm writing for a UofT ECE2500 M.Eng project course.  Given the space constraints 
of the report I may have to drop much of this, but the history of Maxwell's equations may be of interest,
so I thought I'd share before the knife hits the latex.
...
\section{The many faces of electromagnetism.}
