...
\index{\(i\)}
\index{\(I\)}
For this reason, it is often convenient to use an imaginary notation for the \R{2} and \R{3} pseudoscalars
...
\makeanswer{problem:SimpleProducts2:permutationspseudoscalar}{
To verify, swap repeatedly, changing the sign with each swap.  Any cyclic permutation requires exactly two swaps
\begin{equation}\label{eqn:pseudoscalar:380}
\begin{aligned}
\Be_2 \Be_3 \Be_1
&= \Be_2 \lr{\Be_3 \Be_1} \\
&= -\Be_2 \lr{ \Be_1 \Be_3 } \\
...
\end{aligned}
\end{equation}
\begin{equation}\label{eqn:pseudoscalar:400}
\begin{aligned}
   \Be_3 \Be_1 \Be_2
   &= \lr{\Be_3 \Be_1} \Be_2 \\
   &= - \lr{ \Be_1 \Be_3 } \Be_2 \\
