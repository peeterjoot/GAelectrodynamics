...
With the aid of a geometrical model, such as that of \cref{fig:differentialVolume:differentialVolumeFig}, it is possible to convince oneself that each of these surface elements match up to a uniformly oriented clockwise oriented surface.
