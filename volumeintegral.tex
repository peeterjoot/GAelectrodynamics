...
\begin{equation}\label{eqn:volumeintegral:100}
\begin{aligned}
...
\pimageFigure{../figures/gabook/}{normalsOnVolumeAreaElementFig11}{Three parameter volume element.}{fig:normalsOnVolumeAreaElement:normalsOnVolumeAreaElementFig11}{0.4}
...
\begin{equation}\label{eqn:volumeintegral:200}
\begin{aligned}
\boldpartial
...
\begin{equation}\label{eqn:volumeintegral:1621}
\begin{aligned}
...
\begin{equation}\label{eqn:volumeintegral:400}
\begin{aligned}
\int_V F d^3\Bx \boldpartial G
&=
\int du_2 du_3
...
{differentialVolumeFig1}
{differentialVolumeFig2}
{Differential surface of a volume.}{fig:differentialVolume:differentialVolumeFig}{scale=0.05}
...
\begin{equation}\label{eqn:volumeintegral:1641}
