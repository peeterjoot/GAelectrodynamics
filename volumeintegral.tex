...
\begin{equation*}
\int_V dV \spacegrad f = \ointctrclockwise_{\partial V} dA \ncap f
\end{equation*}
...
In \R{3} this can be written as
\begin{equation*}
\int_V dV \spacegrad \cross \Bf = \ointctrclockwise_{\partial V} dA \ncap \cross \Bf,
\end{equation*}
where \( \ncap \) is the outwards normal specified by \( d^2 \Bx = I \ncap dA, \) and \( d^3 \Bx = I dV \).
} % theorem

\maketheorem{Volume integral of bivector function (Stokes', divergence).}{thm:volumeintegral:1681}{
Given a bivector function \( f(\Bx) \), the volume
integral of the (trivector) curl is related to a surface integral by
\begin{equation*}
\int_V d^3 \Bx \cdot \lr{ \boldpartial \wedge f } =
\int_V d^3 \Bx \cdot \lr{ \spacegrad \wedge f } = \ointctrclockwise_{\partial V} d^2\Bx \cdot f.
\end{equation*}
In \R{3} this can be written as
\begin{equation*}
\int_V dV \spacegrad \wedge f = \ointctrclockwise_{\partial V} dA \ncap \wedge f,
\end{equation*}
or, making a duality transformation \( f(\Bx) = I \Bg(\Bx) \), where \( \Bg \) is a vector, by
\begin{equation*}
\int_V dV \spacegrad \cdot \Bg = \ointctrclockwise_{\partial V} dA \ncap \cdot \Bg,
\end{equation*}
where \( \ncap \) is the outwards normal specified by \( d^2 \Bx = I \ncap dA, \) and \( d^3 \Bx = I dV \).
} % theorem
