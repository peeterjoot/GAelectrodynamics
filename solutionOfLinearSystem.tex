...
%%%
\input{intersectionLineAndPlaneProblem.tex}
\input{twoForceStaticsProblem.tex}
...
\pmathImageFigure{../figures/blogit/}{perpPlanesFig1}{Perpendicular bivectors.}{fig:perpPlanes:perpPlanesFig1}{0.4}{ga30_wedge_solution.nb}
