...
\cref{fig:neighbourhood:neighbourhoodFig1},
 has been performed.
\pmathImageFigure{../figures/GAelectrodynamics/}{neighbourhoodFig1}{Neighborhood \( \Norm{\Bx - \Bx'} < \epsilon \).}{fig:neighbourhood:neighbourhoodFig1}{0.5}{neighbourhoodFig1.nb}
