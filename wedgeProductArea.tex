...
\end{aligned}
\end{equation*}
\pmathImageFigure{../figures/GAelectrodynamics/\subfigdir/}{parallelogramAreaFig1}{Parallelogram area.}{fig:parallelogramArea:parallelogramAreaFig1}{0.15}{parallelogramAreaFigure.nb}
is
\begin{equation*}
A =
\pm
