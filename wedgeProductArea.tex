The coordinate representation of the \R{2} wedge product (\cref{eqn:SimpleProducts2:1720}) had a single \( \Be_{12} \) determinant factor, whereas the expansion in coordinates for the general \R{N} wedge product was considerably messier (\cref{eqn:SimpleProducts2:1320}).
