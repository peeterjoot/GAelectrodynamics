...
where \( F_0(\Bx) \) is any solution to the equivalent homogeneous equation \( \LL F_0 = 0 \), and \( G(\Bx, \Bx') \) is the Green's function associated with \cref{eqn:greensFunctionSolutions:340}.
