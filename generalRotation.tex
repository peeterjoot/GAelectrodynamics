...
and that the complex exponential is conjugated under commutatation with any \R{2} vector
...
\end{equation*}
\item
The sign of the argument of a ``complex'' exponential \( e^{ \Ba \wedge \Bb } \) is toggled in a commutation operation with a vector \( \Bp \in S \)
...
This rotation operation is illustration in \cref{fig:Rotation:RotationFig1}, and is seen to
rotate components of the vector that lie in the planar subspace \( S \) by \( \theta \), while leaving the normal components of the vector unchanged.

\imageFigure{../figures/GAelectrodynamics/RotationFig1}{Rotation through plane of pseudoscalar.}{fig:Rotation:RotationFig1}{0.5}
