...
\newtcolorbox[auto counter,number within=chapter]{tablebox}[2][]{colback=Maroon!10!white,
...
%%\end{tablebox}
%
%\begin{tablebox}[tabularx={X||Y|Y|Y|Y}]{Multiplication table}
