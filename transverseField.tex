...
&=
\lr{ \mp k - \Be_3 \frac{\omega}{c} } \spacegrad_t \lr{ E_z + I \eta H_z } \\
&=
\lr{
   \mp k \spacegrad_t E_z
   + \frac{\omega \eta}{c} \Be_3 \cross \spacegrad_t H_z
}
+ I \lr{
   \mp k \eta \spacegrad_t H_z
   -
   \frac{\omega}{c}
...
\end{proof}
A similar expansion for \( E_z, H_z \) in terms of \( \BE_t, \BH_t \) is left to the reader.
