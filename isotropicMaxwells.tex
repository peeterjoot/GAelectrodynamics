...
\end{dmath}
Maxwell's equations have now been consolidated into a single multivector equation!  There is a lot of information packed into this single equation.  In particular, all the conventional Maxwell's equations can be extracted by grade selection operations.
...
Apply grade 0,1,2, and 3 selection operations to \cref{eqn:isotropicMaxwells:580} and determine the multiplicative (scalar or trivector) constants required to obtain \cref{eqn:isotropicMaxwells:500}.
} % problem
