...
With a bit of rescaling, the dot and wedge products of \cref{eqn:maxwellsEquations:60}, \cref{eqn:maxwellsEquations:100} can be added, as can those of \cref{eqn:maxwellsEquations:80}, \cref{eqn:maxwellsEquations:120}.
...
\item \( J = \eta \lr{ v \rho - \BJ } + I \lr{ v \rho_\txtm - \BM } \) ([\si{A/m^2}] (Amperes/square meter)),
