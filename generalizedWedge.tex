...
These properties are also common to the triple product of \R{3} vector algebra, because both the triple product and the wedge of three vectors has a determinant structure,
...
I,
\end{equation}
in which the determinant is recognizable as the triple product.  This shows that the \R{3} wedge of three vectors is triple product times the pseudoscalar
