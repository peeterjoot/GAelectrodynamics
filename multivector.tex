...
Like scalars, there is no direction to such a quantity, but like scalars trivectors may be signed.  The magnitude of a trivector may be interpretted as a volume.
...
\begin{equation*}
\sum_{1 \le i \ne j \cdots \ne m \le N} K_{i j \cdots m} \Be_{i} \Be_{j} \cdots \Be_{m},
\end{equation*}
