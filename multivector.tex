...
\makedefinition{Standard basis and norm}{dfn:multivector:standardbasis}{
...
Such a basis will called a standard basis.  When these dot products are always positive, the vector space is a Euclidean vector space.
}
