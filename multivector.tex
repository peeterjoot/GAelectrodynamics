...
If a bivector is formed from the product of just two orthogonal vectors\footnote{This is always possible for bivectors generated from vectors in \R{3}.}, that bivector is said to represent the plane containing those two vectors.
...
\imageFigure{../figures/GAelectrodynamics/bivectorAdditionInPlaneFig1}{Graphical representation of bivector addition in plane.}{fig:bivectorAdditionInPlane:bivectorAdditionInPlaneFig1}{0.15}
...
\Bx \By + \By \Bx = 0,
\end{dmath}
or \( \By \Bx = - \Bx \By \).  This means that \( \setlr{ \Be_1 \Be_2, \Be_2 \Be_1 } \) is not a basis for the \R{2} bivector space, but that either of these bivectors can serve as the basis for the \R{2} bivector space.  
Similarly, for \R{3}, we may pick a set such as \( \setlr{ \Be_1 \Be_2, \Be_2 \Be_3, \Be_3 \Be_1 } \) for the bivector basis, as illustrated in
...
\item
\(\Be_1 \Be_2 \Be_3, \Be_2 \Be_3 \Be_4\).  These are trivector, and also multivector with only grade 3 components.
\item
