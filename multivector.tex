...
\cref{fig:VectorsWithOppositeOrientation:VectorsWithOppositeOrientationFig1}.  Here the orientation has two aspects, one is the direction in space of the vector, and the other is the relative placement of the head vs. tail of the vector, which is toggled by changing the sign of the vector.
