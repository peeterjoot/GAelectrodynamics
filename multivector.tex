...
\pmathImageFigure{../figures/GAelectrodynamics/\subfigdir/}{bivectorAdditionInPlaneFig1}{Graphical representation of bivector addition in the plane.}{fig:bivectorAdditionInPlane:bivectorAdditionInPlaneFig1}{0.1}{bivectorAddition.nb}
...
\pmathImageFigure{../figures/GAelectrodynamics/\subfigdir/}{AdditionOfBivectorsFig2}{Bivector addition.}{fig:AdditionOfBivectors:AdditionOfBivectorsFig2}{0.3}{circularBivectorsIn3DFig1.nb}
...
\begin{equation*}
\sum_{r \ne s \ne \cdots \ne t} K_{r s \cdots t} \Bx_{r} \Bx_{s} \cdots \Bx_{t},
\end{equation*}
where \( K_{r s \cdots t} \) is a scalar, indexed by \( k \) indexes \( r, s, \cdots, t \).

The number \( k \) of orthogonal vector factors of a k-vector is called the grade.
...
\index{multivector}
\makedefinition{Multivector.}{dfn:multivector:17}{
