...
The Fundamental Theorem of (Geometric) Calculus is a generalization of Stokes theorem \cref{thm:stokesTheoremGeometricAlgebra:1740} to multivector integrals.  Notational, it looks like Stokes theorem with all the dot and wedge products removed.
...
for ``rectangular'' parametrizations.  Note that such a parameterization need not actually be rectangular.
