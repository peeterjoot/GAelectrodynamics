...
\begin{subequations}
\label{eqn:surfaceintegral:140}
\begin{equation}\label{eqn:surfaceintegral:160}
\int_A d^2 \Bx \cdot (\boldpartial \wedge \psi) =
\int_A (d^2 \Bx \cdot \boldpartial) \psi
=
\int_{\partial A} d^1 \Bx \psi
\end{equation}
\begin{equation}\label{eqn:surfaceintegral:180}
...
\begin{dmath}\label{eqn:surfaceintegral:220}
\begin{aligned}
\int_A d^2 \Bx \cdot (\boldpartial \wedge \Bf)
&=
\int_A (d^2 \Bx \cdot \boldpartial) \cdot \Bf \\
...
\begin{dmath}\label{eqn:surfaceintegral:240}
\int_A d^2 \Bx \cdot (\boldpartial \wedge \Bf)
=
\int
...
This shows that the boundary differential \( d^1 \Bx \) in \cref{eqn:surfaceintegral:140} is given by

\begin{dmath}\label{eqn:surfaceintegral:260}
...
%\begin{dmath}\label{eqn:surfaceintegral:280}
\boxedEquation{eqn:surfaceintegral:280}{
\begin{aligned}
