...
span the space at the point that these partials are evaluated.  In the language of differential forms, this localized subspace is called the tangent space.  It is generally desirable to consider parametrizations for which the tangent space volume element is non-zero.  In this case, that is
