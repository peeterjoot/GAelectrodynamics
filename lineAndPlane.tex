...
\lr{ \By - \Bx } \cdot \ncap = 0.
\end{dmath}
These dual forms would also be possible for other special cases (like the equation of a volume in \R{4} and the distance from a point to that volume), but should we desire general relationships valid in all dimenions (even \R{2}), we can stick to \cref{eqn:lineAndPlane:440} and \cref{eqn:lineAndPlane:460}.
