...
\begin{dmath}\label{eqn:amperes:20}
...
\begin{dmath}\label{eqn:amperes:40}
\spacegrad F = J,
\end{dmath}
where the multivector fields and currents are
\begin{dmath}\label{eqn:amperes:60}
\begin{aligned}
F &= \BE + I \eta \BH \\
...
\begin{dmath}\label{eqn:amperes:80}
...
\begin{dmath}\label{eqn:amperes:260}
\ointclockwise_{\partial A} d\Bx F
=
I \int_A dA \lr{ \ncap J - \PD{n}{F} }.
\end{dmath}
