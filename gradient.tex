...
An excellent discussion of the relationships of the reciprocal frame and the gradient can be found in \citep{aMacdonaldVAGC}.

\paragraph{Vector derivative.}
...
\maketheorem{Vector derivative}{thm:gradient:100}{
...
\begin{dmath}\label{eqn:gradient:n}
