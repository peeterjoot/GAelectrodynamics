...
Let's try using Ampere's law as stated in \cref{thm:amperes:280} two compute the field a point on the x-y plane between two
z-axis electric currents of magnitude \( I_1, I_2 \) flowing through the points \( \Bp_1, \Bp_2 \) as illustrated in
