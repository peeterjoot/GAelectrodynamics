...
\makedefinition{Multivector potential.}{thm:staticPotentials:380}{
\( A \) is a \textit{multivector potential} for the field if
\begin{equation*}
F = \gpgrade{\spacegrad A}{1,2},
\end{equation*}
is a solution to \cref{eqn:statics:20}, the Maxwell statics equation.
} % definition

Finding the potential requires solving the equation
\begin{dmath}\label{eqn:staticPotentials:400}
...
Suppose that the potential has all possible grades \( A = A_0 + A_1 + A_2 + A_3 \), then the split of the field
given by
