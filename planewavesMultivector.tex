...
-j \Bk A.
\end{dmath}
Therefore, insertion of \cref{eqn:planewavesMultivector:640} into
...
\( F_0, F_1, F_2, \) and \( F_3 \) are respectively have grades 0,1,2,3, so that
...
The right handed triple relationship between the propagation direction and fields is conventionally expressed not as a pseudoscalar relationship as in
\cref{eqn:planewavesMultivector:740} but as a cross product.  We may do that too if desired
