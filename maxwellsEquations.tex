...
\begin{dmath}\label{eqn:maxwellsEquations:640}
...
=
-\gpgradezero{ (\rspacegrad \bcE) I \bcH }
-\gpgradezero{ (I \bcH \lspacegrad) \bcE }.
\end{dmath}

The gradient operator does not commute with the vector fields, but the flexibility to use cyclic permutation within a scalar selection allows the chain rule to be used to separate the gradient action on \( \bcE \) and \( \bcH \).
