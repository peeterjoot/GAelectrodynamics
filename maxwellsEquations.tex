...
\bcE \cross \bcH
=
\gpgradeone{ -I \bcE \wedge \bcH }
=
\gpgradeone{ -I \bcE \bcH }
=
- \bcE \cdot (I \bcH).
\end{equation}
...
In the time harmonic representation the Poynting relationship is typically written as

\begin{dmath}\label{eqn:maxwellsEquations:800}
\BS = \inv{2} \BE \cross \BH^\conj
\end{dmath}
