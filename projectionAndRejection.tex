...
\end{aligned}
\end{equation}
As expected, all the trivector components cancel perfectly, leaving \( \lr{ \Bx \wedge \ucap } \ucap = \lr{ \Bx \wedge \ucap } \cdot \ucap \).
\makesubanswer{}{problem:projectionAndRejection:rejectionExample1:b}
Now we can compare the above to \( \Bx - {\Bx \cdot \ucap } \ucap \).  First
