...
\makeexample{Cylindrical velocity and acceleration.}{example:projectionAndRejection:1160}{
In \cref{eqn:2dRotations:1280}, and \cref{eqn:2dRotations:1300} we found the cylindrical representation of the velocity and acceleration vectors associated with a radial parameterization \( \Br(r, \theta) = r \rcap(\theta) \).
