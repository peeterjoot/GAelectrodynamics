...
It is straightforward to reexpress all the wedge products above in their dual forms.
With \( B = I \Bf \), that is
...
This implies that \cref{eqn:stokesTheoremCore:1881d} is valid for any \R{3} multivector, generalizing the conventional divergence theorem over a 3D volume to all spatial grades.
