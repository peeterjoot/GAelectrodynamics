...
Given a vector \( \Bx =  x_1 \sigma_1 + x_2 \sigma_2 + x_3 \sigma_3 \), show that the coordinates \( x_i \) can be extracted by evaluating the matrix trace of the matrix product \( \sigma_1 \Bx \).
