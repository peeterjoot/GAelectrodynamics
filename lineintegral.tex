...
where is the one parameter differential form \( d^1 \Bx = da \Bx_a \) over the curve in question.
} % definition
...
\maketheorem{Line integral of a scalar function.}{thm:lineintegral:180}{
