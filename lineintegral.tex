...
This really doesn't require proof as it is
really just a restatement of \cref{thm:fundamentalTheoremOfCalculus:1} for \( k = 1 \).
The proof of \cref{thm:fundamentalTheoremOfCalculus:1} was overkill for the simple line integral case,
and some additional clarity can be obtained by repeating the proof explicitly for the
